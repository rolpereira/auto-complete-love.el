;;; auto-complete-love-tests.el --- ERT tests for auto-complete-love.el  -*- lexical-binding: t; -*-
...
(ert-deftest auto-complete-love-tests--no-repeated-functions ()
  "Check that there are no repeated functions in `auto-complete-love--builtin-functions'."
  (let ((count-functions (make-hash-table :test #'equal))
    ...
    (mapc (lambda (data)
      ...
      auto-complete-love--builtin-functions)
...
(provide 'auto-complete-love-tests)
;;; auto-complete-love-tests.el ends here
